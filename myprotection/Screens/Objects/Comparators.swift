...
protocol ObjectsComparator {
    func compare(_ lhs: Facility, _ rhs: Facility) -> Bool
}

extension ObjectsComparator {
...
class NameFirstObjectsComparator: ObjectsComparator {
...
class AddressFirstObjectsComparator: ObjectsComparator {
...
class StatusFirstObjectsComparator: ObjectsComparator {
